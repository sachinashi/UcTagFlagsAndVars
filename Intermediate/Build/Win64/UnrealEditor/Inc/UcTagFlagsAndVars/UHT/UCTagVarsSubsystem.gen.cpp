...
void FChangeVariableDelegate_DelegateWrapper(const FMulticastScriptDelegate& ChangeVariableDelegate, FGameplayTag Tag, float Variable)
{
	...
	struct Z_CompiledInDeferFile_FID_sachinashi_Unreal_Projects__plugin_OutOfLauncher_UcTagFlagsAndVars_UcTagFlagsAndVars_HostProject_Plugins_UcTagFlagsAndVars_Source_UcTagFlagsAndVars_Public_UCTagVarsSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_sachinashi_Unreal_Projects__plugin_OutOfLauncher_UcTagFlagsAndVars_UcTagFlagsAndVars_HostProject_Plugins_UcTagFlagsAndVars_Source_UcTagFlagsAndVars_Public_UCTagVarsSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_sachinashi_Unreal_Projects__plugin_OutOfLauncher_UcTagFlagsAndVars_UcTagFlagsAndVars_HostProject_Plugins_UcTagFlagsAndVars_Source_UcTagFlagsAndVars_Public_UCTagVarsSubsystem_h_2018118058(TEXT("/Script/UcTagFlagsAndVars"),
		Z_CompiledInDeferFile_FID_sachinashi_Unreal_Projects__plugin_OutOfLauncher_UcTagFlagsAndVars_UcTagFlagsAndVars_HostProject_Plugins_UcTagFlagsAndVars_Source_UcTagFlagsAndVars_Public_UCTagVarsSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_sachinashi_Unreal_Projects__plugin_OutOfLauncher_UcTagFlagsAndVars_UcTagFlagsAndVars_HostProject_Plugins_UcTagFlagsAndVars_Source_UcTagFlagsAndVars_Public_UCTagVarsSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
